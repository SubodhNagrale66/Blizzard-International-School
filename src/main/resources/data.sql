...
INSERT INTO `holidays` (`day`,`reason`,`type`,`created_at`, `created_by`)
  VALUES (' Dec 15 ','BA Day','FEDERAL',CURDATE(),'DBA');
 ...
 // For asssigning admin credential in Person Repository/DB
INSERT INTO `person` (`name`,`email`,`mobile_number`,`pwd`,`role_id`,`created_at`, `created_by`)
  VALUES ('Admin','admin@schoolproject.com','9999999999','$2a$12$4TGeBdN1nMpRwCTuum2ESuGavUWdezsQrqjZbg1GyjC6R01GSp5eS', 1 ,CURDATE(),'DBA');
